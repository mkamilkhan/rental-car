            ...
            <div className="logo-icon-wrapper-large">
              <svg className="professional-logo-large" viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(10, 25)">
                  ...
                  <line x1="7" y1="20" x2="7" y2="30" stroke="#f59e0b" strokeWidth="0.8"/>
                  <line x1="9" y1="20" x2="9" y2="30" stroke="#f59e0b" strokeWidth="0.8"/>
                  <line x1="11" y1="20" x2="11" y2="30" stroke="#f59e0b" strokeWidth="0.8"/>
                  {/* Headlights */}
                  <circle cx="15" cy="22" r="2.5" fill="#ffd700" stroke="#f59e0b" strokeWidth="0.5"/>
                  <circle cx="15" cy="28" r="2.5" fill="#ffd700" stroke="#f59e0b" strokeWidth="0.5"/>
                  {/* Roof Lights */}
                  <rect x="20" y="10" width="8" height="4" rx="1" fill="#f59e0b"/>
                  <rect x="30" y="10" width="8" height="4" rx="1" fill="#f59e0b"/>
                  <rect x="40" y="10" width="8" height="4" rx="1" fill="#f59e0b"/>
                  {/* Wheels */}
                  <circle cx="12" cy="38" r="5" fill="#0e234a" stroke="#f59e0b" strokeWidth="1"/>
                  <circle cx="12" cy="38" r="3" fill="#1e3c72"/>
                  <circle cx="48" cy="38" r="5" fill="#0e234a" stroke="#f59e0b" strokeWidth="1"/>
                  <circle cx="48" cy="38" r="3" fill="#1e3c72"/>
                  {/* Rock/Terrain */}
                  <path d="M8 38 L12 42 L16 38" fill="#2a2a2a" opacity="0.6"/>
                </g>
                {/* Sun Circle */}
                <circle cx="70" cy="20" r="18" fill="#f59e0b" opacity="0.9">
