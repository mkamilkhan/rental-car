      ...
      <div className="login-modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="login-modal-header">
          <div className="login-modal-logo">
            <span className="login-modal-logo-icon">🚗</span>
            <div className="login-modal-logo-text">
              <span className="login-modal-logo-title">OFFROAD</span>
              <span className="login-modal-logo-subtitle">RENTAL HUB</span>
            </div>
          </div>
        </div>
        ...
        <div className="login-modal-body">
          ...
          <p className="login-modal-subtitle">Sign in with Google to continue</p>
